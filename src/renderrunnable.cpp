...
RenderRunnable::RenderRunnable(unsigned int xstart, unsigned int xend, unsigned int ystart, unsigned int yend, unsigned int samplesSqrt, unsigned int depth, Film *f, Camera *c, Integrator *i)
...
void RenderRunnable::run()
{
    ...
    //qDebug() << "New row initialized at " << QThread::currentThread() << ", row" << y_start << "\n";
