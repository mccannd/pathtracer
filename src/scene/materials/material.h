...
//Functions
    ...
    virtual BxDF* GetRandomBxDF() const;
...
//Member Variables
    ...
    bool is_cloud;          //A quick way to check if this material is that of a cloud. If TRUE, the owning geometry is treated as a cloud.
